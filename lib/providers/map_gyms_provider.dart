...
class MapGymsNotifier extends AsyncNotifier<MapGymsState> {
  @override
  Future<MapGymsState> build() async {
    return _fetch();
  }

  Future<MapGymsState> _fetch() async {
...
final mapGymsProvider =
    AsyncNotifierProvider<MapGymsNotifier, MapGymsState>(
  MapGymsNotifier.new,
);